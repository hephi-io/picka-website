  ...
  <div class="group relative w-full h-full">
    <div class="absolute top-0 w-full h-full gradient md:rounded-[8.61px] lg:rounded-[12px] md:p-[22.95px] lg:p-8 group-hover:h-[85%] transition-all duration-[0.3s] ease-in-out">
      ...
      <div class="absolute md:right-[22.95px] md:bottom-[22.95px] md:w-[86.77px] md:h-[71.71px] lg:right-8 lg:bottom-8 lg:w-[98px] lg:h-[100px]">
        <span class="font-medium leading-[100%] tracking-normal align-middle text-[#D9D9D9] md:text-[71.71px] lg:text-[100px]">
          {{ number }}
        </span>
      </div>
    </div>
...
import IconContainer from '~/components/home/how-it-works/components/icon-container.vue';
